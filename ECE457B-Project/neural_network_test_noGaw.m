...
NODES = [length(sequence), 200, 4]; % total number of nodes (without bias in layer)
LAYERS = length(NODES);
...
xIndices = sequence_x-sequence_x(1)+1;
yIndices = sequence_y-sequence_y(1)+xIndices(end);
